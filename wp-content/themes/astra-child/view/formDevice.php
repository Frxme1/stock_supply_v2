            ...
            <form method="POST" action="" id="bulk-action-form-device">
                ...
                <div id="device_table" class="table-wrapper">
                    <table class="table-custom" style="width: 100%;">
                        <thead>
                            <tr>
                                <th class="py-3 text-center" style="width: 45px;"><input type="checkbox" id="selectAll">
                                </th>
                            ...
                            <?php foreach ($rows as $index => $row): ?>
                                <tr class="next-table-row" style="animation-delay: <?= min($index * 0.05, 1) ?>s;">
                                    ...
                                    <td class="text-start align-middle" data-label="Device Info">
                                        <div class="device-title"><?= $row->Brand ?>
                                                ...
                                                <div class="dropdown-menu action-dropdown text-start" style="z-index: 10000;">
                                                    ...
                                                    <?php if (strcasecmp($row->Status, 'Maintenance') === 0): ?>
                                                        <a href="?maintenance=<?= $row->DeviceID ?>"><i
                                                            ...
                                                            Edit</a>
                                                    <?php else: ?>
                                                        <a href="?edit=<?= $row->DeviceID ?>"><i class="fa-solid fa-gear"></i>
                                                            Edit</a>
                                                    <?php endif; ?>
                                                    ...
                                                    <?php if ($status == 'Available'): ?>
                                                        <a href="#"
                                                            onclick="confirmReceive({ id: '<?= esc_js($row->DeviceID) ?>', brand: '<?= esc_js($row->Brand ?? '') ?>', model: '<?= esc_js($row->Model ?? '') ?>', category: '<?= esc_js($row->Category ?? '') ?>', serialNumber: '<?= esc_js($row->SerialNumber ?? '') ?>' }); return false;"><i
