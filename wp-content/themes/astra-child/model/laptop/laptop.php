        ...
        <form method="POST" action="" id="bulk-action-form-laptop">
            ...
            <div class="table-wrapper">
                <table class="table-custom">
                    <thead>
                        <tr>
                            <th class="py-3 text-center" style="width: 45px;"><input type="checkbox" id="selectAll-laptop">
                            </th>
                            ...
                            <tr class="text-nowrap py-2" style="white-space: nowrap;">
                                <td class="align-middle text-center mobile-card-checkbox" style="width: 45px;">
                                    <input type="checkbox" name="bulk_device_ids[]" value="<?= $row->DeviceID ?>"
                                        class="device-checkbox-laptop" data-sn="<?= esc_attr($row->SerialNumber ?? '') ?>">
                                </td>
                                        ...
                                        <div class="dropdown action-menu mb-0 text-center">
                                            ...
                                            <div class="dropdown-menu action-dropdown text-start" style="z-index: 10000;">
                                                ...
                                                <?php if ($row->Status == 'Available'): ?>
                                                    <a href="#"
                                                        onclick="confirmReceive({ id: '<?= esc_js($row->DeviceID) ?>', brand: '<?= esc_js($row->Brand ?? '') ?>', model: '<?= esc_js($row->Model ?? '') ?>', category: '<?= esc_js($row->Category ?? 'Laptop') ?>', serialNumber: '<?= esc_js($row->SerialNumber ?? '') ?>' }); return false;"><i
                                                ...
                                                <?php elseif ($row->Status == 'Maintenance'): ?>
                                                    ...
                                                    <a href="#"
                                                        onclick="confirmLost('<?= esc_js($row->DeviceID) ?>', 'lost', '<?= $dev_action_nonce ?>'); return false;"><i
                                                            class="fa-solid fa-triangle-exclamation text-danger"></i> Lost</a>
                                                <?php elseif ($row->Status == 'Retired' || $row->Status == 'Lost'): ?>
                                                    <a
