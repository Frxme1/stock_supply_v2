<style>
   ...
   ========================================= */
    ...
    #content.site-content {
        ...
        /* Prevent floating bottom nav overlap */
    }
    ...
    .mobile-btn-peek:hover,
    .mobile-btn-peek:active {
    ...
    .quick-action-card.receive .quick-action-icon {
        background: #d1fae5;
        color: #059669;
    }

    .quick-action-card.return .quick-action-icon {
        background: #e0e7ff;
        color: #4338ca;
    }

    .quick-action-card.swap .quick-action-icon {
        background: #fef3c7;
        color: #d97706;
    }

    .quick-action-card.scan .quick-action-icon {
        background: #f1f5f9;
        color: #0f172a;
    }
    ...
    @media (max-width: 768px) {
        ...
        #mobile-filter-container #advanced-filter-form {
            display: block !important;
        }
