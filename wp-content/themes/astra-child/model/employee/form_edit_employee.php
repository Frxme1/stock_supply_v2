...
function form_edit_owner($editing = null)
{
    ...
    <!-- Fully Isolated Edit Employee Component -->
                    ...
                    <div class="emp-fields-grid">
                        ...
                        <div class="emp-field-group emp-span-2">
                            ...
                            <input type="email" name="Email" id="emp_edit_email"
                                value="<?= esc_attr($editing->Email ?? '') ?>" autocomplete="off">
                        </div>
    ...
    <style>
        /* Unbind Beaver Builder & Astra container restrictions on Edit Owner page */
        ...
        @media (min-width: 769px) {
            ...
            #edit-employee-wrapper .emp-glow-orb {
                position: absolute;
                border-radius: 50%;
                filter: blur(80px);
                pointer-events: none;
            ...
            #edit-employee-wrapper .emp-glow-1 {
                top: -20px;
                left: 15%;
                width: 300px;
                height: 300px;
            ...
            #edit-employee-wrapper .emp-glow-2 {
                bottom: 20px;
                right: 10%;
                width: 320px;
                height: 320px;
            ...
            #edit-employee-wrapper .emp-pulse-dot {
                width: 7px;
                height: 7px;
                border-radius: 50%;
            ...
            #edit-employee-wrapper .emp-field-group input[readonly],
            #edit-employee-wrapper .emp-field-group input:disabled,
            #edit-employee-wrapper .emp-field-group select:disabled,
            #edit-employee-wrapper .input-locked {
            ...
            #edit-employee-wrapper .emp-shine {
                position: absolute;
                top: -50%;
                left: -60%;
                width: 40%;
            ...
            #edit-employee-wrapper .emp-avatar-halo {
                position: absolute;
                width: 110px;
                height: 110px;
                border-radius: 50%;
