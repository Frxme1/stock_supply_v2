                                        ...
                                        <div class="dropdown action-menu mb-0 text-center">
                                            ...
                                            <div class="dropdown-menu action-dropdown text-start" style="z-index: 10000;">
                                                ...
                                                <?php if ($status == 'Available'): ?>
                                                    <a href="#"
                                                        onclick="confirmReceive({ id: '<?= esc_js($row->DeviceID) ?>', brand: '<?= esc_js($row->Brand ?? '') ?>', model: '<?= esc_js($row->Model ?? '') ?>', category: '<?= esc_js($row->Category ?? 'Monitor') ?>', serialNumber: '<?= esc_js($row->SerialNumber ?? '') ?>' }); return false;"><i
