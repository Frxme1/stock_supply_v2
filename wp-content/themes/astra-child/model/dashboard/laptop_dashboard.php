...
?>
    <div class="device-dashboard" style="background-color: #fff;">
        <div class="dashboard-cards">
            <?php foreach ($status_config as $status => $config):
                ...
                $percent_laptop = $total_devices > 0 ? round(($total_laptop / $total_devices) * 100, 0) : 0;
            ?>
    ...
    <!-- Summary laptop -->
    <div class="all-device-summary" style="background-color: rgba(21, 165, 218, 0.03); border-radius: 10px; text-align: center;">
        <h4>All Laptop</h4>
        <div class="summary-container">
            <svg class="circle-chart" viewBox="0 0 36 36">
                <circle class="circle-bg" cx="18" cy="18" r="16" />
                <circle class="circle-fill" style="stroke: #15A5DA;" cx="18" cy="18" r="16"
                    stroke-dasharray="<?= $percent_laptop ?>, 100" />
                <text x="18" y="20" class="circle-text" style="fill:#15A5DA"><?= $percent_laptop ?>%</text>
            </svg>
            <div class="device-info">
                <h1 style="color: #15A5DA;"><?= $total_laptop ?></h1>
                <p>Unit</p>
            </div>
        </div>
    </div>
