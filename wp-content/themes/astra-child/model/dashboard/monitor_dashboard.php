...
?>
    ...
    <div class="device-dashboard" style="background-color: #fff; padding:20px 5px; margin: -40px 0px;">
    ...
    <!-- Summary เฉพาะ Monitor -->
    <div class="all-device-summary" style="background-color: rgba(21, 165, 218, 0.03); padding: 30px 20px; border-radius: 10px; text-align: center; margin: 55px 0;">
        <h4>All Monitor</h4>
        <div class="summary-container">
            <svg class="circle-chart" viewBox="0 0 36 36">
                <circle class="circle-bg" cx="18" cy="18" r="16" />
                <circle class="circle-fill" style="stroke: #FDB840;" cx="18" cy="18" r="16"
                    stroke-dasharray="<?= $percent_monitor ?>, 100" />
                <text x="18" y="20" class="circle-text" style="fill:#FDB840;"><?= $percent_monitor ?>%</text>
            </svg>
            <div class="device-info">
                <h1 style="color:#FDB840;"><?= $total_monitor ?></h1>
                <p>Unit</p>
            </div>
        </div>
    </div>
