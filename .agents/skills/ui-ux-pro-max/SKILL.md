...
- **Stack**: React, Next.js, Vue, Nuxt, Svelte, Astro, SwiftUI, React Native, Flutter, Tailwind, shadcn/ui, Angular, Laravel, Three.js, or HTML/CSS.

### Step 2: Generate Design System

Determine palette, typography scale, icon set, interaction feedback, responsive breakpoints, accessibility parameters, and motion curves before implementing code.
